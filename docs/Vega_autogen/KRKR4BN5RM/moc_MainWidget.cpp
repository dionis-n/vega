...
template <> constexpr inline auto MainWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'slotScheduleButtonClicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'slotSettingsButtonClicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'slotCheckSystemTheme'
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->slotScheduleButtonClicked(); break;
        case 1: _t->slotSettingsButtonClicked(); break;
        case 2: _t->slotCheckSystemTheme(); break;
        default: ;
        }
    }
    (void)_a;
